...
export function Logo({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  ...
  const name = settings.app_name || "ForgeFit";
  ...
  return (
    <div className="flex items-center gap-2 font-bold">
      <div className={`flex ${boxSize[size]} items-center justify-center rounded-lg bg-gradient-primary shadow-glow overflow-hidden`}>
